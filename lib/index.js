...
const noPublicFieldInterface = require("./rules/no-public-field-interface");
const noFrameworkInCore = require("./rules/no-framework-in-core");
const enforceNamedExports = require("./rules/enforce-named-exports");
const noCrossBoundaryImport = require("./rules/no-cross-boundary-import");
...
const plugin = {
  ...
  rules: {
    ...
    "no-public-field-interface": noPublicFieldInterface,
    "no-framework-in-core": noFrameworkInCore,
    "enforce-named-exports": enforceNamedExports,
...
// --- Kubit custom rules only (ideal for OxLint projects) ---
